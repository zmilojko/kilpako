class CompetitorsController < MasterController
  # GET /competitors
  ...
  private
    ...
    def owns_object?
      owns_event? @competitor.competition.event or
          current_user == @competitor.user
    end

    # Never trust parameters from the scary internet, only allow the white list through.
    def competitor_params
      params.require(:competitor).permit(:number, :user_id, :competition_id)
    end
end

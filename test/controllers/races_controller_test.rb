...
class RacesControllerTest < ActionController::TestCase
  ...
  test "should create race" do
    assert_difference('Race.count') do
      post :create, race: { competition_id: @race.competition_id, name: @race.name, spots: @race.spots, status: @race.status }
    end
  ...
  test "should update race" do
    patch :update, id: @race, race: { competition_id: @race.competition_id, name: @race.name, spots: @race.spots, status: @race.status }
    assert_redirected_to race_path(assigns(:race))
  end

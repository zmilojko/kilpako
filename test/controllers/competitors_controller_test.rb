...
class CompetitorsControllerTest < ActionController::TestCase
  ...
  test "should create competitor" do
    assert_difference('Competitor.count') do
      post :create, competitor: { competition_id: @competitor.competition_id, number: @competitor.number, user_id: @competitor.user_id }
    end
  ...
  test "should update competitor" do
    patch :update, id: @competitor, competitor: { competition_id: @competitor.competition_id, number: @competitor.number, user_id: @competitor.user_id }
    assert_redirected_to competitor_path(assigns(:competitor))
  end
